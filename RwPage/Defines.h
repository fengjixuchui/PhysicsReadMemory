...
// 宏定义，用于将物理页号转换为页地址。PAGE_SHIFT表示页大小的位移值。
...
// 设置编译器警告级别，并禁用特定警告（警告代码为4201，表示"nonstandard extension used: nameless struct/union"）。

#pragma pack(push, 1)
// 设置结构体的对齐方式，参数1表示按照一个字节的对齐方式。
...
#define Log(x, ...) DbgPrintEx(0, 0, "[Mouse_Driver] " x "\n", __VA_ARGS__)